...
class Attention(nn.Module):
    def __init__(
        ...
        if self.early_stopping:
            self.qkv_dist = nn.Linear(dim, dim * 3, bias=qkv_bias)
            self.qkv_dist.weight.requires_grad = False
            self.qkv_dist.bias.requires_grad = False

    def forward(self, x):
        B, N, C = x.shape  # (64, 198, 768)
        qkv = self.qkv(x)  # (B, 198, 2304)
        if self.early_stopping:
            with torch.no_grad():
                qkv[:, 1] = self.qkv_dist(
                    x[:, 1]
                )  # (B, 1, 768) x (768, 2034) = (64, 1, 2034)
        qkv = qkv.reshape(B, N, 3, self.num_heads, C // self.num_heads).permute(
            2, 0, 3, 1, 4
        )  # (n, 198, 3, 12, 64) --> (3, n, 12, 198, 64)
        # qkv = qkv.reshape(B, N, 3, C).permute(2, 0, 1, 3) #(n, 198, 3, 768) --> (3, n, 198, 768)
...
class VisionTransformer(nn.Module):
    ...
    def __init__(
        ...
        self.patch_embed = PatchEmbedCustom()
    ...
    def interpolate_pos_encoding_plain(self, x, w, h):
        npatch = x.shape[1] - 1
    ...
    def _pos_embed(self, x, w=None, h=None):
        if self.no_embed_class:
            ...
            # * Fix for multi-crop (interpolation)
    ...
    def forward_features(self, x):
        ...
        if self.grad_checkpointing and not torch.jit.is_scripting():
            ...
            # * [CHANGE] remove q_dist
            # x, q_dist = self.blocks(x)
            x = self.blocks(x)
        x = self.norm(x)
        return x
...
def vit_tiny_patch16_224(pretrained=False, **kwargs):
    ...
    model = _create_vision_transformer(
        "vit_tiny_patch16_224", pretrained=pretrained, **dict(model_kwargs, **kwargs)
    )
    return model
...
def vit_tiny_patch16_384(pretrained=False, **kwargs):
    ...
    model_kwargs = dict(patch_size=16, embed_dim=192, depth=12, num_heads=3)
    model = _create_vision_transformer(
        "vit_tiny_patch16_384", pretrained=pretrained, **dict(model_kwargs, **kwargs)
    )
    return model
...
def vit_small_patch32_224(pretrained=False, **kwargs):
    ...
    model = _create_vision_transformer(
        "vit_small_patch32_224", pretrained=pretrained, **dict(model_kwargs, **kwargs)
    )
    return model
...
def vit_small_patch32_384(pretrained=False, **kwargs):
    ...
    model_kwargs = dict(patch_size=32, embed_dim=384, depth=12, num_heads=6)
    model = _create_vision_transformer(
        "vit_small_patch32_384", pretrained=pretrained, **dict(model_kwargs, **kwargs)
    )
    return model
...
def vit_small_patch16_224(pretrained=False, **kwargs):
    ...
    model = _create_vision_transformer(
        "vit_small_patch16_224", pretrained=pretrained, **dict(model_kwargs, **kwargs)
    )
    return model
...
def vit_small_patch16_384(pretrained=False, **kwargs):
    ...
    model_kwargs = dict(patch_size=16, embed_dim=384, depth=12, num_heads=6)
    model = _create_vision_transformer(
        "vit_small_patch16_384", pretrained=pretrained, **dict(model_kwargs, **kwargs)
    )
    return model
...
def vit_small_patch8_224(pretrained=False, **kwargs):
    ...
    model = _create_vision_transformer(
        "vit_small_patch8_224", pretrained=pretrained, **dict(model_kwargs, **kwargs)
    )
    return model
...
def vit_base_patch32_224(pretrained=False, **kwargs):
    ...
    model = _create_vision_transformer(
        "vit_base_patch32_224", pretrained=pretrained, **dict(model_kwargs, **kwargs)
    )
    return model
...
def vit_base_patch32_384(pretrained=False, **kwargs):
    ...
    model_kwargs = dict(patch_size=32, embed_dim=768, depth=12, num_heads=12)
    model = _create_vision_transformer(
        "vit_base_patch32_384", pretrained=pretrained, **dict(model_kwargs, **kwargs)
    )
    return model
...
def vit_base_patch16_224(pretrained=False, **kwargs):
    ...
    model = _create_vision_transformer(
        "vit_base_patch16_224", pretrained=pretrained, **dict(model_kwargs, **kwargs)
    )
    return model
...
def vit_base_patch16_384(pretrained=False, **kwargs):
    ...
    model_kwargs = dict(patch_size=16, embed_dim=768, depth=12, num_heads=12)
    model = _create_vision_transformer(
        "vit_base_patch16_384", pretrained=pretrained, **dict(model_kwargs, **kwargs)
    )
    return model
...
def vit_base_patch8_224(pretrained=False, **kwargs):
    ...
    model = _create_vision_transformer(
        "vit_base_patch8_224", pretrained=pretrained, **dict(model_kwargs, **kwargs)
    )
    return model
...
def vit_large_patch32_224(pretrained=False, **kwargs):
    ...
    model = _create_vision_transformer(
        "vit_large_patch32_224", pretrained=pretrained, **dict(model_kwargs, **kwargs)
    )
    return model
...
def vit_large_patch32_384(pretrained=False, **kwargs):
    ...
    model_kwargs = dict(patch_size=32, embed_dim=1024, depth=24, num_heads=16)
    model = _create_vision_transformer(
        "vit_large_patch32_384", pretrained=pretrained, **dict(model_kwargs, **kwargs)
    )
    return model
...
def vit_large_patch16_224(pretrained=False, **kwargs):
    ...
    model = _create_vision_transformer(
        "vit_large_patch16_224", pretrained=pretrained, **dict(model_kwargs, **kwargs)
    )
    return model
...
def vit_large_patch16_384(pretrained=False, **kwargs):
    ...
    model_kwargs = dict(patch_size=16, embed_dim=1024, depth=24, num_heads=16)
    model = _create_vision_transformer(
        "vit_large_patch16_384", pretrained=pretrained, **dict(model_kwargs, **kwargs)
    )
    return model
...
def vit_large_patch14_224(pretrained=False, **kwargs):
    ...
    model = _create_vision_transformer(
        "vit_large_patch14_224", pretrained=pretrained, **dict(model_kwargs, **kwargs)
    )
    return model
...
def vit_huge_patch14_224(pretrained=False, **kwargs):
    ...
    model = _create_vision_transformer(
        "vit_huge_patch14_224", pretrained=pretrained, **dict(model_kwargs, **kwargs)
    )
    return model
...
def vit_giant_patch14_224(pretrained=False, **kwargs):
    ...
    model = _create_vision_transformer(
        "vit_giant_patch14_224", pretrained=pretrained, **dict(model_kwargs, **kwargs)
    )
    return model
...
def vit_gigantic_patch14_224(pretrained=False, **kwargs):
    ...
    model_kwargs = dict(
        patch_size=14, embed_dim=1664, mlp_ratio=64 / 13, depth=48, num_heads=16
    )
    model = _create_vision_transformer(
...
def vit_base_patch16_plus_240(pretrained=False, **kwargs):
    """ViT-Base (ViT-B/16+)"""
    model_kwargs = dict(
        patch_size=16, embed_dim=896, depth=12, num_heads=14, init_values=1e-5
    )
    model = _create_vision_transformer(
...
def vit_small_patch16_36x1_224(pretrained=False, **kwargs):
    ...
    """
    model_kwargs = dict(
        patch_size=16, embed_dim=384, depth=36, num_heads=6, init_values=1e-5
    )
    model = _create_vision_transformer(
...
def eva_large_patch14_196(pretrained=False, **kwargs):
    ...
    model_kwargs = dict(
        patch_size=14, embed_dim=1024, depth=24, num_heads=16, global_pool="avg"
    )
    model = _create_vision_transformer(
...
def eva_large_patch14_336(pretrained=False, **kwargs):
    ...
    model = _create_vision_transformer(
        "eva_large_patch14_336", pretrained=pretrained, **dict(model_kwargs, **kwargs)
    )
    return model
...
def flexivit_small(pretrained=False, **kwargs):
    """FlexiViT-Small"""
    model_kwargs = dict(
        patch_size=16, embed_dim=384, depth=12, num_heads=6, no_embed_class=True
    )
    model = _create_vision_transformer(
        "flexivit_small", pretrained=pretrained, **dict(model_kwargs, **kwargs)
    )
    return model
...
def flexivit_base(pretrained=False, **kwargs):
    """FlexiViT-Base"""
    model_kwargs = dict(
        patch_size=16, embed_dim=768, depth=12, num_heads=12, no_embed_class=True
    )
    model = _create_vision_transformer(
        "flexivit_base", pretrained=pretrained, **dict(model_kwargs, **kwargs)
    )
    return model
...
def flexivit_large(pretrained=False, **kwargs):
    """FlexiViT-Large"""
    model_kwargs = dict(
        patch_size=16, embed_dim=1024, depth=24, num_heads=16, no_embed_class=True
    )
    model = _create_vision_transformer(
        "flexivit_large", pretrained=pretrained, **dict(model_kwargs, **kwargs)
    )
    return model
