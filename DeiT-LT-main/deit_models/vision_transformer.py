...
from .utils_quant import SoftmaxBinaryQuantizer, BinaryQuantizer, ZMeanBinaryQuantizer, BinaryLinear_STE, BinaryLinear_adapscaling, BinaryLinear_adapscaling_1w32a, BinaryLinear_STE_32a
...
default_cfgs = generate_default_cfgs(
    {
        ...
        "vit_base_patch8_224.augreg2_in21k_ft_in1k": _cfg(hf_hub_id="timm/"),
        ...
        "vit_base_patch32_clip_224.laion2b_ft_in12k_in1k": _cfg(
            hf_hub_id="timm/", mean=OPENAI_CLIP_MEAN, std=OPENAI_CLIP_STD
        ),
        ...
        "vit_base_patch16_clip_224.laion2b_ft_in12k_in1k": _cfg(
            hf_hub_id="timm/", mean=OPENAI_CLIP_MEAN, std=OPENAI_CLIP_STD, crop_pct=0.95
        ),
        ...
        "vit_huge_patch14_clip_224.laion2b_ft_in12k_in1k": _cfg(
            hf_hub_id="timm/", mean=OPENAI_CLIP_MEAN, std=OPENAI_CLIP_STD, crop_pct=1.0
        ),
        ...
        "vit_base_patch32_plus_256": _cfg(
            url="", input_size=(3, 256, 256), crop_pct=0.95
        ),
        "vit_base_patch16_plus_240": _cfg(
            url="", input_size=(3, 240, 240), crop_pct=0.95
        ),
        ...
        "flexivit_small.1200ep_in1k": _cfg(
            url="https://storage.googleapis.com/big_vision/flexivit/flexivit_s_i1k.npz",
            custom_load=True,
            hf_hub_id="timm/",
            input_size=(3, 240, 240),
            crop_pct=0.95,
        ...
        "flexivit_small.600ep_in1k": _cfg(
            url="https://storage.googleapis.com/big_vision/flexivit/flexivit_s_i1k_600ep.npz",
            custom_load=True,
            hf_hub_id="timm/",
            input_size=(3, 240, 240),
            crop_pct=0.95,
        ...
        "flexivit_small.300ep_in1k": _cfg(
            url="https://storage.googleapis.com/big_vision/flexivit/flexivit_s_i1k_300ep.npz",
            custom_load=True,
            hf_hub_id="timm/",
            input_size=(3, 240, 240),
            crop_pct=0.95,
        ...
        "flexivit_base.1200ep_in1k": _cfg(
            url="https://storage.googleapis.com/big_vision/flexivit/flexivit_b_i1k.npz",
            custom_load=True,
            hf_hub_id="timm/",
            input_size=(3, 240, 240),
            crop_pct=0.95,
        ...
        "flexivit_base.600ep_in1k": _cfg(
            url="https://storage.googleapis.com/big_vision/flexivit/flexivit_b_i1k_600ep.npz",
            custom_load=True,
            hf_hub_id="timm/",
            input_size=(3, 240, 240),
            crop_pct=0.95,
        ...
        "flexivit_base.300ep_in1k": _cfg(
            url="https://storage.googleapis.com/big_vision/flexivit/flexivit_b_i1k_300ep.npz",
            custom_load=True,
            hf_hub_id="timm/",
            input_size=(3, 240, 240),
            crop_pct=0.95,
        ...
        "flexivit_base.1000ep_in21k": _cfg(
            url="https://storage.googleapis.com/big_vision/flexivit/flexivit_b_i21k_1000ep.npz",
            custom_load=True,
            hf_hub_id="timm/",
            input_size=(3, 240, 240),
            crop_pct=0.95,
        ...
        "flexivit_base.300ep_in21k": _cfg(
            url="https://storage.googleapis.com/big_vision/flexivit/flexivit_b_i21k_300ep.npz",
            custom_load=True,
            hf_hub_id="timm/",
            input_size=(3, 240, 240),
            crop_pct=0.95,
        ...
        "flexivit_large.1200ep_in1k": _cfg(
            url="https://storage.googleapis.com/big_vision/flexivit/flexivit_l_i1k.npz",
            custom_load=True,
            hf_hub_id="timm/",
            input_size=(3, 240, 240),
            crop_pct=0.95,
        ...
        "flexivit_large.600ep_in1k": _cfg(
            url="https://storage.googleapis.com/big_vision/flexivit/flexivit_l_i1k_600ep.npz",
            custom_load=True,
            hf_hub_id="timm/",
            input_size=(3, 240, 240),
            crop_pct=0.95,
        ...
        "flexivit_large.300ep_in1k": _cfg(
            url="https://storage.googleapis.com/big_vision/flexivit/flexivit_l_i1k_300ep.npz",
            custom_load=True,
            hf_hub_id="timm/",
            input_size=(3, 240, 240),
            crop_pct=0.95,
        ...
        "flexivit_base.patch16_in21k": _cfg(
            url="https://storage.googleapis.com/big_vision/flexivit/vit_b16_i21k_300ep.npz",
            custom_load=True,
            hf_hub_id="timm/",
            input_size=(3, 240, 240),
            crop_pct=0.95,
        ...
        "flexivit_base.patch30_in21k": _cfg(
            url="https://storage.googleapis.com/big_vision/flexivit/vit_b30_i21k_300ep.npz",
            custom_load=True,
            hf_hub_id="timm/",
            input_size=(3, 240, 240),
            crop_pct=0.95,
