...
def main():
    ...
    args = parser.parse_args()
    'student/distill_T2.0/enc_balance_distill_student1.0/CE_False'
    ...
    balance_distill = 'enc_balance_distill_'+ args.distill_option + (str)(args.balance_factor)
...
def train(train_loader, teacher_model, lws_model, student_enc, student_fc,
    ...
    for i, (images, target) in enumerate(train_loader):
        ...
        if not args.fp16:
            ...
            feats = student_enc(images)
            logits = student_fc(feats)
            enc_loss = kl_loss(logits, teacher_out, cls_num_list=args.cls_num_list)
            if args.losssrc2:
                enc_loss *= 1 / 2
            ...
            with autocast():
                ...
                fc_loss = kd_kl_loss(logits, teacher_out)
                fc_optimizer.zero_grad()
