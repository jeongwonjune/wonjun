...
python LT/distill_featdistill.py \
--epochs 400 \
-b 128 \
--dataset cifar100 \
--num_classes 100 \
--imb_ratio 0.01 \
--pretrained ./test/mislas/mixup/cifar100_0.01_vit_epochs100_lr0.0004_bs128_sgd/moco_ckpt.best.pth.tar \
--balance_ce \
--teacher_model 'resnet152' \
--student_model 'reactnet' \
--maximize \
-d 'None' \
