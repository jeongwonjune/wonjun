...
def resnet32(num_classes=100, use_norm=False, penult_feat=False):
    return ResNet_s(BasicBlock, [5, 5, 5], num_classes=num_classes, use_norm=use_norm, penult_feat=penult_feat)
