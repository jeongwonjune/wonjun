...
def main():
    ...
    # if 'st' in args.balance_feature_option:
    #     args.bkd_student = True
    # else:
    #     args.bkd_student = False
    # if 'te' in args.balance_feature_option:
    #     args.bkd_teacher = True
    # else:
    #     args.bkd_teacher = False
