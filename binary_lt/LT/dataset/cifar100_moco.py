...
class CIFAR100_LT(object):
    def __init__(self, root='./data/cifar100', imb_type='exp',
        ...
        moco_dataset = IMBALANCECIFAR100(root=root, imb_type=imb_type, imb_factor=imb_factor, rand_number=0,
...
if __name__ == '__main__':
    dataset = CIFAR100_LT(num_works=0)
