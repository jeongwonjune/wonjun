...
parser.add_argument('--root_path', type=str, default='./runs/renew/teacher/paco/')
...
def main():
    ...
    if args.dataset in ['cub', 'cifar10', 'cifar100']:
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    train_transform = [transforms.Compose(transform_train), transforms.Compose(augmentation_sim)]
