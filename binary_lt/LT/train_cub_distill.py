...
def main():
    ...
    if args.reverse_kldiv:
        args.root_path = os.path.join(args.root_path, 'reverse_kldiv')
    args.mark = '_'.join([
        dataset,
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if args.losssrc3:
        ...
        student_model = moco.builder.MoCo(reactnet_imagenet,
                                          ...
                                          mlp=True, feat_dim=1024, normalize=False,
    ...
    if args.losssrc3:
        criterion_paco.cal_weight_for_classes(args.cls_num_list)
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        train(train_loader, teacher_model, student_model,
              criterion_ce, criterion_paco, kl_loss,
    ...
    for i, (images, target) in enumerate(train_loader):
        ...
        if args.losssrc3:
            ...
            if not args.fp16:
                ...
                total_loss = kl_loss(logits, teacher_out, cls_num_list=args.cls_num_list) / 2
            ...
            if not args.fp16:
                ...
                total_loss = kl_loss(logits, teacher_out, cls_num_list=args.cls_num_list)
            else:
                with autocast():
                    logits = student_model(images)
                    total_loss = kl_loss(logits, teacher_out, cls_num_list=args.cls_num_list)
